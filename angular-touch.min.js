...
$swipe.bind(element,{'start':function(coords,event){startCoords=coords;valid=!0},'cancel':function(event){valid=!1},'end':function(coords,event){if(validSwipe(coords)){scope.$apply(function(){element.triggerHandler(eventName);swipeHandler(scope,{$event:event})})}}})}}])}
